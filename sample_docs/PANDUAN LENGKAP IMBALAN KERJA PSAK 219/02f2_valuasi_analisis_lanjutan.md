...
**Q: Variabel mana yang paling sensitive?** A: Salary increase rate > Discount rate. Kenaikan salary 1% → impact Rp10,59M, penurunan discount 1% → impact Rp10,90M.
...
**Q: Mengapa total maturity analysis Rp228,88M lebih besar dari PVDBO Rp86,69M?** A: Maturity analysis menggunakan undiscounted cash flows, sedangkan PVDBO sudah di-discount ke present value.
